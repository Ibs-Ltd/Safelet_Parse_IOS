...
@interface StopFollowUserRequest : BaseRequest

/**
 *    Stop Follow User by follow me object id
...
+ (instancetype _Nonnull)stopFollowUser:(NSString * _Nonnull)objectId
