...
@interface GetFollowMeGuardians : BaseRequest


/**
 *    Get Follow Me guardians by follow me object id
...
+ (instancetype _Nonnull)GetFollowMeGuardians:(NSString * _Nonnull)objectId
